...
namespace DirectX
{
    namespace SimpleMath
    {
        ...
        struct Quaternion : public XMFLOAT4
        {
            ...
            void CDECL RotateTowards(const Quaternion& target, float maxAngle, Quaternion& result) const noexcept;
            ...
            static void CDECL FromToRotation(const Vector3& fromDir, const Vector3& toDir, Quaternion& result) noexcept;
            static Quaternion FromToRotation(const Vector3& fromDir, const Vector3& toDir) noexcept;

            static void CDECL LookRotation(const Vector3& forward, const Vector3& up, Quaternion& result) noexcept;
        ...
        public:
            ...
            static RECT CDECL ComputeDisplayArea(DXGI_SCALING scaling, UINT backBufferWidth, UINT backBufferHeight, int outputWidth, int outputHeight) noexcept;
        #endif
            static RECT CDECL ComputeTitleSafeArea(UINT backBufferWidth, UINT backBufferHeight) noexcept;
        };
